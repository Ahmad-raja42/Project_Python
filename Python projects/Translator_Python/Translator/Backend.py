...
# let's create a function to extract the list of abbreviations
def get_abbreviations():
    # sourcery skip: for-append-to-extend, inline-immediately-returned-variable, list-comprehension
    # sorcery skip: inline-immediately-returned-variable, list-comprehension
    # sorcery skip: for-append-to-extend, inline-immediately-returned-variable, list-comprehension
    # let's see what all languages can our translator work with
    language_info = googletrans.LANGUAGES
